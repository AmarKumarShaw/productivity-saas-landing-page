...
<div
      className={twMerge(
                "flex flex-col  gap-6 items-center justify-center mt-10",
        ...
        >
            {
              props.testimonials.map(({text,imageSrc,name,username})=>{
                return(
                     ...
                     <Image height={200} width={200} src={imageSrc} 
                      alt="Testimonial Image" 
                     className="h-10 w-10 rounded-full"
                     />
                      <div className="flex flex-col">
                      <div className="tracking-tight leading-5">{name}</div>
  ...
  <section className="bg-white">
      <div className="container p-4">
          <div className="section-heading">
            ...
            <div className="tag text-center">Testimonials</div>
            </div>
            <h2 className="section-title">What our users say</h2>
            <p className="section-description">
              From intuitive design to powerful features, our app has become an
              esssential tool for users around the world.
            </p>
          </div>
